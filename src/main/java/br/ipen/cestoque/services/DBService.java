...
public class DBService {
	...
	public void instantiateTestDatabase() {
		// TODO Auto-generated method stub
				...
				Insumo i1 = new Insumo(null, "bandeja de liofilizador estéril", "BANDEJA DE ACO INOXIDAVEL P/LIOFILIZADOS", 0.0, "8171", "", true, new Date(), 3.0,3.0,"","","","hamilton", new Date(), un1, 123, true, new Date(), true, new Date(), "123", null, true, false, true, null, null);
				Insumo i2 = new Insumo(null, "ACIDO ASCORBICO PARA PREPARO DE SOLUCAO", "ACIDO ASCORBICO PA REF.A5960 (FR 100G) SIGMA", 0.0, "7588", "", true, new Date(), 1.0, 1.0,"","","","hamilton", new Date(), un2, 123, true, new Date(), true, new Date(), "123",null, false,true, true, null, null);
				Insumo i3 = new Insumo(null, "ACETATO DE SODIO TRIHIDRATADO FR. 500G (106267) MERCK", "ACETATO DE SODIO 10%", 0.0, "7588", "", true, new Date(), 5.0, 5.0, "","","","hamilton", new Date(), un2, 123, true, new Date(), true, new Date(), "123",null,true,true, true, null, null);
