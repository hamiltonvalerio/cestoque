...
public class DBService {
	...
	public void instantiateTestDatabase() {
		// TODO Auto-generated method stub
				...
				Localizacao l1 = new Localizacao(null, "BUFFER RL", false, "Hamilton", new Date(), true, false);
				Localizacao l2 = new Localizacao(null, "CONTROLE DE QUALIDADE", true, "Hamilton", new Date(), true, false);
